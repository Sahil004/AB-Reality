            ...
            <div className="container">
                <div className="services">
                    <div className="section-top pb-5 text-center">
                        <span className="section-sub-heading text-uppercase">Work Flow</span>
                        <h2 className="section-heading text-white fs-1">How It Works</h2>
                    </div>
                </div>
                <div className="row">
                    {serviceData.map((service, index) => (
                        <div key={index} className="col-md-3 text-center py-4 px-4 text-white">
